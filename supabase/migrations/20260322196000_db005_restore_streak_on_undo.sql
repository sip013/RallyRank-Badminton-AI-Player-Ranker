-- DB-005: Persist streak_before on match_history and restore it in undo_match
-- instead of zeroing streaks. Body inherits rem003 (locks + disputed-at-log + created_at).
--
-- ROLLBACK:
--   recreate log_match + undo_match from 20260322192000_rem003_serialize_elo_undo.sql;
--   optional: alter table public.match_history drop column if exists streak_before;
